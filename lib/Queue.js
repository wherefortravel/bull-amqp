          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                promise = this._chan._runOnce(setup);
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                _context11.next = 6;
                return this._chan._runOnce(setup);
                        ...
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            chan.consume(replyQueue, function (msg) {
                              ...
                              var replyHandler = _this4._replyHandlers.get(correlationId);
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 7:
                ...
                _context14.next = 12;
                return new _bluebird2.default(function (resolve, reject) {
                  _this5._replyHandlers.set(correlationId, resolve);
                }).timeout(timeout).catch(_bluebird2.default.TimeoutError, function (err) {
                  _this5._replyHandlers.delete(correlationId);
